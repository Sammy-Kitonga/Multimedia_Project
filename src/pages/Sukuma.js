  ...
  return (
    <section className="section fade-in tribe-sukuma">
      ...
      >
        ...
        <p>
          <strong>Annual Festivals:</strong> Major celebrations held during June–September include dance competitions like Bugobogobo and Bukomyalume, showcasing traditional songs, colorful costumes, ceremonial masks, and community drumming.
        </p>
      </MorphingCard>
